...
class Teachers(db.Model):
    ...
    def __init__(self, school_id, subject, name, surname, patronymic, sex):
...
class Students(db.Model):
    ...
    def __init__(self, school_id, class_id, name, surname, patronymic, sex, id_user):
        self.school_id = school_id
        self.name = name
        self.surname = surname
        self.patronymic = patronymic
...
class Assessment(db.Model):
    ...
    def __init__(self, id_school, id_student, id_teacher, text_field, lesson_interest, lesson_comprehensibility, teacher_behavior):
        self.id_school = id_school
